...
3. `data/datasource/api/index.dart`: export the new file.
4. `data/datasource/api/service_factory.dart`: register the game in
   `_apiRegistry` and `_pagingRegistry`.
5. `assets/image/game/<game>.png`: add the game icon, named after the game ID.
