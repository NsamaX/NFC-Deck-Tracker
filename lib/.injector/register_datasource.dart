...
void _collectionLocalDatasource() {
  ...
  locator.registerLazySingleton(() => FindCollectionLocalDatasource(locator<SQLiteService>()));
...
void _settingLocalDatasource() {
  ...
  locator.registerLazySingleton(() => UpdateSettingLocalDatasource(locator<SharedPreferencesService>()));
}
...
void _recordRemoteDatasource() {
  ...
  locator.registerLazySingleton(() => ImportRecordRemoteDatasource(locator<FirestoreService>()));
  locator.registerLazySingleton(() => ShareRecordRemoteDatasource(locator<FirestoreService>()));
