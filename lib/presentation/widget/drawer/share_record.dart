...
class _DrawerContainer extends StatelessWidget {
      ...
      child: Column(
        ...
        children: [
          _DrawerItem(
            ...
            text: locale.translate('page_deck_tracker.share_record'),
            onTap: () => _showQRCodeCreatedRoom(context, cards),
          ),
          ...
          _DrawerItem(
            ...
            text: locale.translate('page_deck_tracker.import_record'),
            onTap: () {
  ...
  void _showQRCodeCreatedRoom(BuildContext context, List<CardEntity> cards) {
    showDialog(
      context: context,
      ...
      builder: (_) => Dialog(
        ...
        child: GestureDetector(
          ...
          child: Center(
            child: GestureDetector(
              onTap: () => context.read<TrackerBloc>().add(ShareRecordEvent(
